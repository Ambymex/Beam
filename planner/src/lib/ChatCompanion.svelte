...
You MUST respond with a single, valid JSON object. Do not output conversational text outside the JSON. Your response must match this schema:
{
  ...
  "react": "black_hearts" | "sparks" | "tungsten_strike" | "liquid_hearts" | "cherry_blossoms" | "sleepy_stars" | "rose_throw" | null,  \\ OPTIONAL ambient visual gesture — see REACTS section below. Omit or null for most messages.
  "actions": [
