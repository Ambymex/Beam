...
export const PHENOMENON_NOTES: Record<AtmosphericPhenomenon, string> = {
  ...
  brockenSpectre: 'An immense, lagging shadow uncoils through lit fog. Its head-centred glory and depth-warped edges should feel uncannily real, never like a second creature.',
};
...
export const ATMOSPHERIC_STUDIES: Record<string, AtmosphericStudy> = {
  ...
  larger_weather: {
    ...
    note: 'Baily stays foregrounded while an enormous, night-dark projection swims through the mist behind them.',
    effects: [studyEffect('brockenSpectre', {
      ...
      projectionScale: 2.75,
      perspectiveStretch: 1.42,
      projectionBlur: 3.6,
      projectionOpacity: 0.62,
      fogDepth: 0.78,
      motionLag: 0.95,
      haloIntensity: 0.24,
      projectionOffsetX: 8,
      projectionOffsetY: -27,
      distortionNoise: 0.44,
      previewSource: true,
    })],
  },
};
